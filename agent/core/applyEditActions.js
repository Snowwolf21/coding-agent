...
import { validateFilePath, validateEditContent, } from "./safety.js";
export function acceptEdit(id) {
    const edit = agentState.project.suggestions.find((e) => e.id === id);
    if (!edit) {
    ...
    try {
        ...
        const currentContent = fs.readFileSync(edit.path, "utf8");
        ...
        validateEditContent(edit.original, edit.updated);
        // apply edit safely
        const updatedContent = currentContent.replace(edit.original, edit.updated);
...
//# sourceMappingURL=applyEditActions.js.map